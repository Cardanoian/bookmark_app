...
- 이후: 승인 독후감·장르·A등급·일일 작성량·게임·미션·챌린지 등 **활동 마일스톤을 달성하면 새 몬스터를 자동 발견**(알 부화 연출). 랜덤 뽑기·유료 요소 없음.
- 레어도별 난이도, 조건 집계 계약과 24개 라인의 전체 해금표는 [`monster_unlocks.md`](./monster_unlocks.md)를 단일 진실로 사용한다.
