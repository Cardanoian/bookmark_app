...
### 13.1 5축 루브릭 · 성취기준 (2022 개정 국어 5~6학년군)
| 축(key) | 라벨 | 성취기준 | 의미 |
|---------|------|----------|------|
| content | 내용 이해 | [6국05-03] | 인물·사건·배경 |
| emotion | 감상 표현 | [6국03-03] | 생각·느낌 |
| life | 삶과 연결 | [6국05-06] | 삶·경험 연관·성찰(★A 유도) |
| structure | 구성·근거 | [6국03-05] | 고쳐쓰기·문장 연결 |
| spelling | 맞춤법 | [6국04-06] | 표기 정확성 |

A/B/C 판정: 5축 평균 → A(삶 적극 연관·성찰) / B(감상 有, 삶 연결 약) / C(줄거리 위주). 포인트 A30/B20/C10.
