...
### 4.2 독서게임 10종 (`GAMES`, L1023)

| ID | UI 라벨 | 설명 |
|----|---------|------|
| `book` | 📖 책 퀴즈 | 교사가 출제한 책별 퀴즈 |
| `classic` | 📜 고전 | 고전 독서 퀴즈 (`CLASSICS`) |
| `battle` | 🆚 퀴즈대결 | 실시간 타임드 대결 (봇 대결) |
| `balance` | ⚖️ 밸런스 | A/B 투표 토론형 |
| `quiz` | ❓ 퀴즈 | 일반 독서 퀴즈 |
| `golden` | 🔔 골든벨 | 서바이벌 퀴즈 (`GOLDENBELL`) |
| `bingo` | 🎯 빙고 | 독서 빙고 |
| `vocab` | 📚 어휘 | 어휘 게임 |
| `whoami` | 🕵️ 인물맞히기 | 등장인물 추리 |
| `marathon` | 🏃 마라톤 | 연속 퀴즈 |
